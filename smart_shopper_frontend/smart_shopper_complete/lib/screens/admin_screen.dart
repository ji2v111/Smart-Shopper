        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Row(children: [
            _Stat(icon: Icons.people_alt_rounded,
              iconBg: const Color(0xFFF0F0F0), iconColor: AppTheme.primary,
              label: t('users'),    value: '${_users.length}'),
            const SizedBox(width: 10),
            _Stat(icon: Icons.inventory_2_rounded,
              iconBg: const Color(0xFFF2F2F2), iconColor: AppTheme.primary,
          ...
          OutlinedButton.icon(
            ...
            icon: const Icon(Icons.delete_sweep_rounded, color: const Color(0xFF333333)),
            label: Text(t('deleteAll'), style: const TextStyle(color: const Color(0xFF333333))),
                    ...
                    child: ListTile(
                      ...
                      trailing: Row(mainAxisSize: MainAxisSize.min, children: [
                        _MiniTag(u['role'] ?? 'user',
                          u['role'] == 'admin' ? AppTheme.primary : AppTheme.primary),
                        // Promote / Demote
                        IconButton(
                        ...
                        IconButton(
                          ...
                          icon: const Icon(Icons.person_remove_outlined,
                            color: const Color(0xFF333333), size: 20),
                          onPressed: () async {
