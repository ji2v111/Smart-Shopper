        ...
        : SingleChildScrollView(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                child: Row(children: [
                  ...
                  Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Row(children: [
                      _Badge(
                        label: u['role'] ?? 'user',
                        color: u['role'] == 'admin' ? AppTheme.primary : AppTheme.secondary,
                      ),
                      ...
                      _Badge(
                        ...
                        color: u['is_verified'] == 1
                            ? AppTheme.secondary : AppTheme.warning,
                      ),
                    ]),
                  ])),
                ]),
              ...
              Row(children: [
                ...
                const SizedBox(width: 12),
                Expanded(child: _InfoCard(
                  icon: const Icon(Icons.price_check_rounded, color: AppTheme.secondary, size: 28),
                  label: t('avgPrice'),
